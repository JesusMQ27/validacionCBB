...
class ConcarExport implements FromCollection, /* WithHeadings, */ WithCustomStartCell, WithEvents {
    ...
    public function collection() {
        ...
        $data = Contabilidad::lista_concar($per_id);
        return $data;
    }

//obligatoria clase abstracta de withHea
    /* public function headings(): array {
      return ['Campo', 'Sub Diario', 'Número de Comprobante', 'Fecha de Comprobante', 'Código de Moneda', 'Glosa Principal', 'Tipo de Cambio', 'Tipo de Conversión', 'Flag de Conversión de Moneda', 'Fecha Tipo de Cambio', 'Cuenta Contable',
      ...
      "Tipo Cambio para 'F'", 'Importe de IGV sin derecho crédito fiscal'];
      } */
